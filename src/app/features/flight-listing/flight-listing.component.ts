...
export class FlightListingComponent implements OnInit {
  ...
  buildFilterOptions(): void {
    ...
    const timeRanges = [
      { label: 'Sáng sớm (00:00 - 05:59)', start: '00:00', end: '05:59', count: 0 },
      { label: 'Buổi sáng (06:00 - 11:59)', start: '06:00', end: '11:59', count: 0 },
      { label: 'Buổi chiều (12:00 - 17:59)', start: '12:00', end: '17:59', count: 0 },
      { label: 'Buổi tối (18:00 - 23:59)', start: '18:00', end: '23:59', count: 0 }
    ];
  ...
  applyFilters(): void {
    ...
    this.filteredFlights = this.flights.filter(flight => {
      ...
      // Stops filter
      if (filters.stops.length > 0 && !filters.stops.includes(flight.stops.length)) {
        return false;
      }
  ...
  getPageItems(): Flight[] {
    ...
    return this.filteredFlights.slice(startIndex, startIndex + this.itemsPerPage);
  }
    ...
    return [
      ...
      },
      {
        ...
        airline: {
          code: 'QH',
          name: 'Bamboo Airways',
          logo: 'assets/images/airlines/bamboo.png'
        },
        departureAirport: {
          code: 'HAN',
          name: 'Nội Bài',
